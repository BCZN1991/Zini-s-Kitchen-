<%-- 
    Document   : index
    Created on : 29 Jul 2020, 12:21:13 PM
    Author     : Tshepho Motala
--%>
...
<html lang="zxx">
			...
			<div class="container">
				<h1>
					<a class="navbar-brand" href="index.html">
						<i class="fas fa-utensils"></i>Zini's Snacks
					</a>
				</h1>
				...
				<div class="slider-info bg1">
					<div class="w3l-overlay">
						<div class="banner-text text-center container">
							<h3 class="text-white mb-md-4 mb-3">Welcome to our luxurious 
								<span>Zini's homemade tasty Snacks</span>
							</h3>
	...
	<div class="about py-5" id="about">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-center text-dark mb-sm-5 mb-4">
				<span>Welcome to our Zini's homemade Snacks</span> world's no.1 tasty food</h3>
			<div class="row about-bottom-w3l text-center pt-lg-5">
				<div class="col-sm-6 about-grid">
					<div class="about-grid-main">
						...
						<p> Zini's homemade tasty snacks is situated in the heart of Daveyton</p>
				...
				<div class="col-sm-6 about-grid mt-sm-0 mt-4">
					<div class="about-grid-main">
						...
						<p>Our foods are 100% meat and fresh vegetables</p>
						<a href="#" class="button-w3ls mt-4" data-toggle="modal" data-target="#exampleModalCenter1">Read More
							<i class="fas fa-long-arrow-alt-right ml-3"></i>
						</a>
					</div>
			...
			<div class="row pt-lg-5">
				...
				<div class="col-lg-4 mt-lg-0 mt-4">
					<div class="service1-wthree">
						...
						<p>We delivery everywhere around Daveyton and benoni</p>
					</div>
					<div class="service1-wthree my-4">
						<h4>2</h4>
						<h6 class="text-dark mt-4 mb-2">Catering</h6>
						<p>We cater for all occasions</p>
					</div>
					<div class="service1-wthree">
						<h4>3</h4>
						<h6 class="text-dark mt-4 mb-2">Events</h6>
						<p>We host cook inn's around East rand</p>
					</div>
				</div>
		...
		<div class="container py-xl-5 py-lg-3">
			<div class="row">
				<div class="grids-w3ls-right-2 offset-lg-7 offset-sm-4">
					<h4 class="title text-dark mb-sm-5 mb-4">Our burgers are made from 100% beef patties or Chicken fillet and fresh prepared vegetables and selected sauces</h4>
					<p class="mt-4">We offer our burgers in all sizes and for breakfast and lunches only </p>
				...
				<div class="col-lg-6">
					<div class="address-right p-sm-5 p-4">
						<div class="address-info wow fadeInRight animated" data-wow-delay=".5s">
							...
							<p>6123 Eislen Street, Daveyton 1520,
								<span>Ekurhuleni City,Gauteng, SA</span>
							</p>
						</div>
						...
						<div class="address-info agileits-info wow fadeInRight animated" data-wow-delay=".6s">
							...
							<p>
								<a href="mailto:example@mail.com"> zinimajali@gmail.com</a>
							</p>
							<p>
								<a href="mailto:example@mail.com"> zinimajali2@gmail.com</a>
							</p>
						</div>
					</div>
				</div>
	...
	<footer class="pt-5">
			...
			<div class="row footer-grids py-4">
				...
				<div class="col-lg-2 col-6 footer-grid footer-contact">
					...
					<ul class="list-unstyled">
						...
						<li class="mt-2">
							<a href="mailto:info@example.com">zinimajali@gmail.com</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="copy_right">
			<p class="text-center text-white py-sm-4 py-3">© 2020 Zini's Snacks. All rights reserved | Design by
				<a href="#">Ntombizini Jali</a>
			</p>
